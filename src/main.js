...
const setData = (socialObjet) => {
  ...
  facebookCard.children[3].classList.remove('green')
  facebookCard.children[3].classList.remove('red')
  ...
  twitterCard.children[3].classList.remove('green')
  twitterCard.children[3].classList.remove('red')
  ...
  instagramCard.children[3].classList.remove('green')
  instagramCard.children[3].classList.remove('red')
  ...
  youtubeCard.children[3].classList.remove('green')
  youtubeCard.children[3].classList.remove('red')
  ...
  facebookPages.children[2].classList.remove('green')
  facebookPages.children[2].classList.remove('red')
  ...
  facebookLikes.children[2].classList.remove('green')
  facebookLikes.children[2].classList.remove('red')
  ...
  instagramLikes.children[2].classList.remove('green')
  instagramLikes.children[2].classList.remove('red')
  ...
  instagramViews.children[2].classList.remove('green')
  instagramViews.children[2].classList.remove('red')
  ...
  twitterRetweets.children[2].classList.remove('green')
  twitterRetweets.children[2].classList.remove('red')
  ...
  twitterLikes.children[2].classList.remove('green')
  twitterLikes.children[2].classList.remove('red')
  ...
  youtubeLikes.children[2].classList.remove('green')
  youtubeLikes.children[2].classList.remove('red')
  ...
  youtubeViews.children[2].classList.remove('green')
  youtubeViews.children[2].classList.remove('red')
